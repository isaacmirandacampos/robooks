// kinava prepara ebooks baixados para uma biblioteca já organizada, sem criar
...
//
//	kinava index                      constrói/atualiza o índice da biblioteca
//	kinava ingest ~/Downloads/livros  mostra o que aconteceria com os arquivos novos
//	kinava ingest -apply ~/Downloads/livros
//	kinava check arquivo.epub         só pergunta "isto já existe na biblioteca?"
package main
...
import (
	...
	"github.com/isaacdmcampos/kinava/internal/ingest"
	"github.com/isaacdmcampos/kinava/internal/target"
)

const usage = `kinava — prepara ebooks para uma biblioteca organizada

USO
  kinava <comando> [flags] [caminho]
...
func cmdIndex(args []string) int {
	...
	idxPath := fs.String("index", "", "arquivo de índice (padrão: ~/.cache/kinava/index.gz)")
